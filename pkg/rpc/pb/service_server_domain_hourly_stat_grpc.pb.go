...
// All implementations must embed UnimplementedServerDomainHourlyStatServiceServer
...
// UnimplementedServerDomainHourlyStatServiceServer must be embedded to have forward compatible implementations.
