...
// All implementations must embed UnimplementedServerStatBoardChartServiceServer
...
// UnimplementedServerStatBoardChartServiceServer must be embedded to have forward compatible implementations.
