...
// All implementations must embed UnimplementedNSKeyServiceServer
...
// UnimplementedNSKeyServiceServer must be embedded to have forward compatible implementations.
