...
// All implementations must embed UnimplementedUserTicketLogServiceServer
...
// UnimplementedUserTicketLogServiceServer must be embedded to have forward compatible implementations.
