...
// All implementations must embed UnimplementedHTTPHeaderServiceServer
...
// UnimplementedHTTPHeaderServiceServer must be embedded to have forward compatible implementations.
