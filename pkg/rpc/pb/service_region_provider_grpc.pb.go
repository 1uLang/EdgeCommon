...
// All implementations must embed UnimplementedRegionProviderServiceServer
...
// UnimplementedRegionProviderServiceServer must be embedded to have forward compatible implementations.
