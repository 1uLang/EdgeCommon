...
// UnimplementedLatestItemServiceServer can be embedded to have forward compatible implementations.
...
func RegisterLatestItemServiceServer(s *grpc.Server, srv LatestItemServiceServer) {
	s.RegisterService(&_LatestItemService_serviceDesc, srv)
}
...
var _LatestItemService_serviceDesc = grpc.ServiceDesc{
