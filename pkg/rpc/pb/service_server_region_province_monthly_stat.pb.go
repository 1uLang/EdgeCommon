...
func (c *serverRegionProvinceMonthlyStatServiceClient) FindTopServerRegionProvinceMonthlyStats(ctx context.Context, in *FindTopServerRegionProvinceMonthlyStatsRequest, opts ...grpc.CallOption) (*FindTopServerRegionProvinceMonthlyStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.ServerRegionProvinceMonthlyStatService/findTopServerRegionProvinceMonthlyStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServerRegionProvinceMonthlyStatServiceServer can be embedded to have forward compatible implementations.
...
func RegisterServerRegionProvinceMonthlyStatServiceServer(s *grpc.Server, srv ServerRegionProvinceMonthlyStatServiceServer) {
	s.RegisterService(&_ServerRegionProvinceMonthlyStatService_serviceDesc, srv)
}
...
func _ServerRegionProvinceMonthlyStatService_FindTopServerRegionProvinceMonthlyStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ServerRegionProvinceMonthlyStatService/FindTopServerRegionProvinceMonthlyStats",
	}
...
var _ServerRegionProvinceMonthlyStatService_serviceDesc = grpc.ServiceDesc{
