...
// All implementations must embed UnimplementedMonitorNodeServiceServer
...
// UnimplementedMonitorNodeServiceServer must be embedded to have forward compatible implementations.
