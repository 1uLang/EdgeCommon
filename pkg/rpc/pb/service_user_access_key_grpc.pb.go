...
// All implementations must embed UnimplementedUserAccessKeyServiceServer
...
// UnimplementedUserAccessKeyServiceServer must be embedded to have forward compatible implementations.
