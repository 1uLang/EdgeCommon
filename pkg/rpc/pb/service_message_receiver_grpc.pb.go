...
// All implementations must embed UnimplementedMessageReceiverServiceServer
...
// UnimplementedMessageReceiverServiceServer must be embedded to have forward compatible implementations.
