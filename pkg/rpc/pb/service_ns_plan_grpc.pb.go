...
// All implementations must embed UnimplementedNSPlanServiceServer
...
// UnimplementedNSPlanServiceServer must be embedded to have forward compatible implementations.
