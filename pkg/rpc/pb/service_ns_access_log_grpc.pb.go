...
// All implementations must embed UnimplementedNSAccessLogServiceServer
...
// UnimplementedNSAccessLogServiceServer must be embedded to have forward compatible implementations.
