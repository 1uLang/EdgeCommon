...
func (c *reportNodeServiceClient) ReportNodeStream(ctx context.Context, opts ...grpc.CallOption) (ReportNodeService_ReportNodeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ReportNodeService_ServiceDesc.Streams[0], "/pb.ReportNodeService/reportNodeStream", opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations must embed UnimplementedReportNodeServiceServer
...
// UnimplementedReportNodeServiceServer must be embedded to have forward compatible implementations.
