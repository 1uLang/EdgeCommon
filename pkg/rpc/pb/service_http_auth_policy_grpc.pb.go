...
// All implementations must embed UnimplementedHTTPAuthPolicyServiceServer
...
// UnimplementedHTTPAuthPolicyServiceServer must be embedded to have forward compatible implementations.
