...
// All implementations must embed UnimplementedMessageRecipientServiceServer
...
// UnimplementedMessageRecipientServiceServer must be embedded to have forward compatible implementations.
