...
// All implementations must embed UnimplementedNSDomainGroupServiceServer
...
// UnimplementedNSDomainGroupServiceServer must be embedded to have forward compatible implementations.
