...
// All implementations must embed UnimplementedServerRegionCityMonthlyStatServiceServer
...
// UnimplementedServerRegionCityMonthlyStatServiceServer must be embedded to have forward compatible implementations.
