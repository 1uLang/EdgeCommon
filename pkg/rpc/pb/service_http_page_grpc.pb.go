...
// All implementations must embed UnimplementedHTTPPageServiceServer
...
// UnimplementedHTTPPageServiceServer must be embedded to have forward compatible implementations.
