...
// All implementations must embed UnimplementedIPItemServiceServer
...
// UnimplementedIPItemServiceServer must be embedded to have forward compatible implementations.
