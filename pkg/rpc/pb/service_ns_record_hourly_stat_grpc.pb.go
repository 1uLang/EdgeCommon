...
// All implementations must embed UnimplementedNSRecordHourlyStatServiceServer
...
// UnimplementedNSRecordHourlyStatServiceServer must be embedded to have forward compatible implementations.
