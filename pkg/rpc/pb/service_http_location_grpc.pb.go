...
// All implementations must embed UnimplementedHTTPLocationServiceServer
...
// UnimplementedHTTPLocationServiceServer must be embedded to have forward compatible implementations.
