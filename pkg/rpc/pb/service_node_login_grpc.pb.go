...
// All implementations must embed UnimplementedNodeLoginServiceServer
...
// UnimplementedNodeLoginServiceServer must be embedded to have forward compatible implementations.
