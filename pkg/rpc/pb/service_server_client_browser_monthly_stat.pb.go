...
func (c *serverClientBrowserMonthlyStatServiceClient) FindTopServerClientBrowserMonthlyStats(ctx context.Context, in *FindTopServerClientBrowserMonthlyStatsRequest, opts ...grpc.CallOption) (*FindTopServerClientBrowserMonthlyStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.ServerClientBrowserMonthlyStatService/findTopServerClientBrowserMonthlyStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServerClientBrowserMonthlyStatServiceServer can be embedded to have forward compatible implementations.
...
func RegisterServerClientBrowserMonthlyStatServiceServer(s *grpc.Server, srv ServerClientBrowserMonthlyStatServiceServer) {
	s.RegisterService(&_ServerClientBrowserMonthlyStatService_serviceDesc, srv)
}
...
func _ServerClientBrowserMonthlyStatService_FindTopServerClientBrowserMonthlyStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ServerClientBrowserMonthlyStatService/FindTopServerClientBrowserMonthlyStats",
	}
...
var _ServerClientBrowserMonthlyStatService_serviceDesc = grpc.ServiceDesc{
