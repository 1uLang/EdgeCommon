...
// All implementations must embed UnimplementedNSDomainServiceServer
...
// UnimplementedNSDomainServiceServer must be embedded to have forward compatible implementations.
