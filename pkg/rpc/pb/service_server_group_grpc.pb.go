...
// All implementations must embed UnimplementedServerGroupServiceServer
...
// UnimplementedServerGroupServiceServer must be embedded to have forward compatible implementations.
