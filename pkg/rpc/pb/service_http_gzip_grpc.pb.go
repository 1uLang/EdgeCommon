...
// All implementations must embed UnimplementedHTTPGzipServiceServer
...
// UnimplementedHTTPGzipServiceServer must be embedded to have forward compatible implementations.
