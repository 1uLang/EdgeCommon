...
// All implementations must embed UnimplementedMessageTaskLogServiceServer
...
// UnimplementedMessageTaskLogServiceServer must be embedded to have forward compatible implementations.
