...
// UnimplementedACMEAuthenticationServiceServer can be embedded to have forward compatible implementations.
...
func RegisterACMEAuthenticationServiceServer(s *grpc.Server, srv ACMEAuthenticationServiceServer) {
	s.RegisterService(&_ACMEAuthenticationService_serviceDesc, srv)
}
...
var _ACMEAuthenticationService_serviceDesc = grpc.ServiceDesc{
