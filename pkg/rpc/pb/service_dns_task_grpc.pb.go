...
// All implementations must embed UnimplementedDNSTaskServiceServer
...
// UnimplementedDNSTaskServiceServer must be embedded to have forward compatible implementations.
